...
async function downloadTokenSlip() {
    ...
    if (typeof html2pdf === "undefined") {
        alert("PDF सिस्टम लोड नहीं हुआ। इंटरनेट चालू करके दोबारा प्रयास करें।");
        return;
    }

    // PDF बनाने के समय सामग्री को स्पष्ट रूप से दिखाएं
    const oldDisplay = pdfContent.style.display;
    const oldVisibility = pdfContent.style.visibility;
    ...
    try {
        ...
        alert("PDF डाउनलोड करने में समस्या हुई।");

    }

    // पुरानी स्थिति वापस करें
    pdfContent.style.display = oldDisplay;
    pdfContent.style.visibility = oldVisibility;
}
